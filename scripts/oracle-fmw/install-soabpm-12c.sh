...
cd $INSTALL_DIR
su $OS_USER -c "java -jar $INFRA_JAR -ignoreSysPrereqs -novalidation -silent -responseFile /tmp/fmw_infra.rsp -invPtrLoc /tmp/oraInst.loc -jreLoc $JAVA_HOME"


cat > /tmp/fmw_soa.rsp <<EOF
[ENGINE]
...
cd $INSTALL_DIR
su $OS_USER -c "java -jar $SOA_JAR -ignoreSysPrereqs -novalidation -silent -responseFile /tmp/fmw_soa.rsp -invPtrLoc /tmp/oraInst.loc -jreLoc $JAVA_HOME"
